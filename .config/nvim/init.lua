    ...
    config = function()
      require('nvim-tree').setup {
        on_attach = function()
          ...
          vim.keymap.set('n', '<leader>ta', api.fs.create, opts 'Create File Or Directory')
          -- vim.keymap.set('n', 'bd', api.marks.bulk.delete, opts 'Delete Bookmarked')
          -- vim.keymap.set('n', 'bt', api.marks.bulk.trash, opts 'Trash Bookmarked')
          -- vim.keymap.set('n', 'bmv', api.marks.bulk.move, opts 'Move Bookmarked')
          -- vim.keymap.set('n', 'B', api.tree.toggle_no_buffer_filter, opts 'Toggle Filter: No Buffer')
          vim.keymap.set('n', '<leader>tc', api.fs.copy.node, opts 'Copy')
          -- vim.keymap.set('n', 'C', api.tree.toggle_git_clean_filter, opts 'Toggle Filter: Git Clean')
          -- vim.keymap.set('n', '[c', api.node.navigate.git.prev, opts 'Prev Git')
          -- vim.keymap.set('n', ']c', api.node.navigate.git.next, opts 'Next Git')
          vim.keymap.set('n', '<leader>td', api.fs.remove, opts 'Delete')
          ...
          vim.keymap.set('n', '<leader>tM', api.tree.toggle_no_bookmark_filter, opts 'Toggle Filter: No Bookmark')
          vim.keymap.set('n', '<leader>tm', api.marks.toggle, opts 'Toggle Bookmark')
          -- vim.keymap.set('n', 'o', api.node.open.edit, opts 'Open')
          -- vim.keymap.set('n', 'O', api.node.open.no_window_picker, opts 'Open: No Window Picker')
          vim.keymap.set('n', '<leader>tp', api.fs.paste, opts 'Paste')
          -- vim.keymap.set('n', 'P', api.node.navigate.parent, opts 'Parent Directory')
          -- vim.keymap.set('n', 'q', api.tree.close, opts 'Close')
          vim.keymap.set('n', '<leader>tr', api.fs.rename, opts 'Rename')
